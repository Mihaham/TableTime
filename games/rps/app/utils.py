...
def log_game_finish(game_id: int, finished_by_user_id: int, winner_user_id: int = None, final_state: dict = None):
    ...
    try:
        ...
        requests.post(f"{LOGGING_SERVICE_URL}/finish", json=payload, timeout=1)
    except:
        pass
